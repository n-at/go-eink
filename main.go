...
func main() {
	...
	imageRedSaturationThreshold := flag.Int("image-red-saturation-threshold", 25, "saturation threshold for red image (%)")
	imageRedLightnessThreshold := flag.Int("image-red-lightness-threshold", 75, "lightness threshold for red image (%)")
	...
	imageYellowSaturationThreshold := flag.Int("image-yellow-saturation-threshold", 25, "saturation threshold for yellow image (%)")
